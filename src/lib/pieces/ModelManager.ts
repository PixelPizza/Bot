...
export class Model<TModelAttributes = any, TCreationAttributes = TModelAttributes> extends SequelizeModel<
	TModelAttributes,
	TCreationAttributes
> {
...
export abstract class ModelManager<
	ModelClass extends Model<ModelClass["_attributes"], ModelClass["_creationAttributes"]>
> extends Piece<ModelManagerOptions<ModelClass>> {
	...
	public bulkCreate(
		records: readonly ModelClass["_creationAttributes"][],
		options?: BulkCreateOptions<ModelClass["_attributes"]>
	) {
	...
	public update(
		values: { [key in keyof ModelClass["_attributes"]]?: Fn | Col | Literal | ModelClass["_attributes"][key] },
		options: UpdateOptions<ModelClass["_attributes"]>
	) {
